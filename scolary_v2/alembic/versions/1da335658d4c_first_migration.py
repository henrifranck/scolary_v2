...
Revision ID: 1da335658d4c
Revises: 
Create Date: 2025-12-25 08:16:54.335338
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('route_api', sa.String(length=255), nullable=False),
    sa.Column('route_ui', sa.String(length=255), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('use_for_card', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('level', sa.Enum('L1', 'L2', 'L3', 'M1', 'M2', name='levelenum'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('level', 'id_academic_year', 'id_mention', name='uq_annual_register_level_mention')
    )
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('path', sa.String(length=512), nullable=False),
    sa.Column('type', sa.Enum('image', 'video', 'audio', 'document', 'other', name='filetypeenum'), nullable=False),
    ...
    sa.Column('enrollment_status', sa.Enum('pending', 'rejected', 'selected', 'registered', 'former', name='enrollmentstatusenum'), nullable=False),
    ...
    sa.Column('num_carte', sa.String(length=255), nullable=True),
    sa.Column('id_academic_year', sa.Integer(), nullable=True),
    sa.Column('register_type', sa.Enum('SELECTION', 'REGISTRATION', name='registertypeenum'), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('num_carte', 'id_academic_year', 'register_type', name='uq_annual_register_student_year')
    )
